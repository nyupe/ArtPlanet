...
/* ERD와 다른 시퀀스 (컬럼명이 너무 길어서 오류나서 수정한 시퀀스) 시작 */
DROP SEQUENCE SEQ_PRO;
DROP SEQUENCE SEQ_PROJECTREWARD_rewardNo;
DROP SEQUENCE SEQ_PROJECTUPDATE_UPDATENO;
DROP SEQUENCE SEQ_CR_CLASSRESERVATIONNO;
DROP SEQUENCE SEQ_SUP;
/* ERD와 다른 시퀀스 (컬럼명이 너무 길어서 오류나서 수정한 시퀀스) 끝 */



/* Create Sequences */

CREATE SEQUENCE SEQ_ARTCLASS_classNo NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_ATTACHFILE_attachfileNo NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_ATTACHIMAGE_imageNo NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_AUTH_SECURITY_authorityNo NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_BLOGPOST_blogNo NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_CATEGORIE_categorieNo NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_CLASSOPENINGDATE_DateNo NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_GCS_fileNo NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_HASHTAG_tagNo NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_MEMBER_memberNo NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_PROJECT_projectNo NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_QNA_qnaNo NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_REPLY_replyNo NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_STORAGE_fileNo NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_SUBSCRIBE_subscribeNo NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_TAG_tagNo NOCACHE NOCYCLE;

/* ERD와 다른 시퀀스 (컬럼명이 너무 길어서 오류나서 수정한 시퀀스) 시작 */
CREATE SEQUENCE SEQ_PRO NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_PROJECTREWARD_rewardNo NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_PROJECTUPDATE_UPDATENO NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_CR_CLASSRESERVATIONNO NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_SUP NOCACHE NOCYCLE;
/* ERD와 다른 시퀀스 (컬럼명이 너무 길어서 오류나서 수정한 시퀀스) 끝 */
/* 안드로이드 관련 */
--------------------------------------------------------
--  DDL for Table FCM_TOKENS
--------------------------------------------------------

  CREATE TABLE "ARTPLANET"."FCM_TOKENS" 
   (   "ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "ARTPLANET"."SYS_C0012193" ON "ARTPLANET"."FCM_TOKENS" ("ID") 
...
--------------------------------------------------------
  ...
  ALTER TABLE "ARTPLANET"."FCM_TOKENS" ADD PRIMARY KEY ("ID")
