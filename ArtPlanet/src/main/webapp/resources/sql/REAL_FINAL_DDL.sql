...
CREATE SEQUENCE SEQ_PRO INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE SEQ_PROJECTREWARD_rewardNo INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE SEQ_PROJECTUPDATE_UPDATENO INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE SEQ_CR_CLASSRESERVATIONNO INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE SEQ_PROJECTREWARD_rewardNo INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE SEQ_SUP INCREMENT BY 1 START WITH 1;
