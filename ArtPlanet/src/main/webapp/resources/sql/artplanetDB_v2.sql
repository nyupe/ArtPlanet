...
(
	...
	-- 권한명
	authorityName nvarchar2(20) DEFAULT 'ROLE_USER' NOT NULL,
	-- 회원번호
	memberNo number NOT NULL,
...
COMMENT ON COLUMN AUTHORITY.authorityNo IS '권한번호';
COMMENT ON COLUMN AUTHORITY.authorityName IS '권한명';
COMMENT ON COLUMN AUTHORITY.memberNo IS '회원번호';
