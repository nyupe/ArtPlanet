...
(
	...
	res_cd nvarchar2(10),
	-- 배치키
	batch_key nvarchar2(20) DEFAULT '인증실패',
	-- 카드코드
	card_cd nvarchar2(10) DEFAULT '인증실패',
	-- 주문자명
...
(
	...
	app_time nvarchar2(20),
	-- 승인번호
	app_no nvarchar2(10) DEFAULT '결제실패',
	-- 응답코드
	res_cd nvarchar2(10),
	-- 회원번호
	memberNo number NOT NULL,
...
(
	...
	buyr_mail nvarchar2(30),
	-- 카드명
	card_name nvarchar2(10) DEFAULT '결제실패',
	-- 승인시간
	app_time nvarchar2(20) DEFAULT '결제실패',
	-- 승인번호
	app_no nvarchar2(10) DEFAULT '결제실패',
	-- 응답코드
	res_cd nvarchar2(10),
...
COMMENT ON TABLE PROJPAY IS '프로젝트결제 테이블';
COMMENT ON COLUMN PROJPAY.tno IS '거래번호';
COMMENT ON COLUMN PROJPAY.ordr_idxx IS '주문번호';
COMMENT ON COLUMN PROJPAY.good_mny IS '결제금액';
