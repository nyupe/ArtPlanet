...
(
	...
	-- 인원수
	numberOfPeople nvarchar2(100),
	-- 수강료
	tuitionFee nvarchar2(100),
	-- 주소
...
(
	...
	-- 개설날짜
	openingDate nvarchar2(100),
	-- 개설시각
	openingTime nvarchar2(100),
	-- 클래스 글번호
	classNo number NOT NULL,
	PRIMARY KEY (DateNo)
);
...
COMMENT ON TABLE CLASSOPENINGDATE IS '아트클래스 개설날짜정보';
...
COMMENT ON TABLE CLASSRESERVATION IS '아트클래스 예약정보';
