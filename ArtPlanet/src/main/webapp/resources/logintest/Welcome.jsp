                                    ...
                                    <div class="modal-body">
                                        <h5 class="modal-title">
                                            <h4 class="mt-2">
                                                ...
                                                ArtPlanet의 아이디는 
                                                <span class="text-success" style="font-weight: bold; text-decoration: underline;"/> ${param.id }</span>입니다</span></div>
                                        </h5>
                                         
                                        </div>
                                        
                                    <div class="modal-footer d-block text-center" style="margin-top: 100px">
                                        <button class="btn-wide mb-2 mr-2 btn-pill btn btn-primary btn-lg btn-block">ArtPlanet 시작하기</button>
                                    </div>
                                </div>
                            </div>
