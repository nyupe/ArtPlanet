                            ...
                            <div class="modal-dialog w-100">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer d-block text-center" style="margin-top: 100px">
                                        <a href="<c:url value='/Login'/>"><button class="btn-wide mb-2 mr-2 btn-pill btn btn-primary btn-lg btn-block">ArtPlanet 시작하기</button></a>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript" src="<c:url value='/resources/kero/assets/scripts/main.07a59de7b920cd76b874.js'/>"/>
				...
				<div class="d-flex h-100 justify-content-center align-items-center">
					<div class="mx-auto app-login-box col-md-8">
						<div class="col" align="center"
							style="margin-bottom: 25px; margin-top: 150px">
							<a href="<c:url value='/Search/Artwork'/>"> <img
								class="img-fluid" src="<c:url value='/resources/img/logo.png'/>"
								alt="로고이미지" /></a>
						</div>
						<div class="modal-dialog w-100">
							<div class="modal-content">
									...
									<h5 class="modal-title">
										<h4 class="mt-2">
											<div style="margin-top: 150px" align="center"
												class="display-4">환영합니다!</div>
											<div align="center" style="color: black; margin-top: 20px">
												<span>회원가입을 축하합니다. </br> 회원님의 아이디는 <span
													class="text-success" style="text-decoration: underline;" />
													${param.id }
												</span>입니다</span>
											</div>
									</h5>
								...
								<div class="modal-footer d-block text-center"
									...
									<a href="<c:url value='/Login'/>"><button
											class="btn-wide mb-2 mr-2 btn-pill btn btn-primary btn-lg btn-block">ArtPlanet
											시작하기</button></a>
								</div>
							</div>
						</div>
						<div class="text-center text-black opacity-8 mt-3">Copyright
							© ArtPlanet 2019</div>
					</div>
				</div>
			</div>
	...
	<script type="text/javascript"
		src="<c:url value='/resources/kero/assets/scripts/main.07a59de7b920cd76b874.js'/>" />
</body>
</html>
