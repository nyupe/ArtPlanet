                        ...
                        <div class="h-100 d-flex bg-white justify-content-center align-items-center col-md-12 col-lg-8">
                            <div class="mx-auto app-login-box col-sm-12 col-md-8 col-lg-6">
                                <div style="padding-bottom: 50px">
                                  ...
                                  <h4><span>회원님의 <span class="text-primary">비밀번호</span>를 입력해주세요.</span></h4>
                                <div style="padding-bottom: 100px">
                                    <form class="">
                                        <div class="form-row">
                                            <div class="col-md-12">
                                                <div class="position-relative form-group"><input name="email" id="exampleEmail" placeholder="비밀번호를 입력해주세요" type="text" class="form-control"></div>
                                            </div>
                                        </div>
