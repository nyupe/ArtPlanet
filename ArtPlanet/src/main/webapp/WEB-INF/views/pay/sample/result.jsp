			...
			<div class="row">
				...
				<div class="order-details-wrapper">
					...
					<div class="order-details fix">
						<form action="#">
							<ul>
								<li><p class="strong float-left">처리결과</p><p class="last-child strong float-right">t</p></li>
								<li><p class="float-left">결과코드</p><p class="last-child float-right">EL로받을곳</p></li>
								<li><p class="float-left">결과메시지</p><p class="last-child float-right">EL로받을곳</p></li>
								<li><p class="strong float-left">주문정보</p><p class="last-child strong float-right"></p></li>
								<li><p class="float-left">주문번호</p><p class="last-child float-right">EL로받을곳</p></li>
								<li><p class="float-left">KCP거래번호</p><p class="last-child float-right">EL로받을곳</p></li>
								<li><p class="float-left">결제금액</p><p class="last-child float-right">EL로받을곳</p></li>
								<li><p class="float-left">상품명</p><p class="last-child float-right">EL로받을곳</p></li>
								<li><p class="float-left">주문자명</p><p class="last-child float-right">EL로받을곳</p></li>
								<li><p class="float-left">주문자 전화번호</p><p class="last-child float-right">EL로받을곳</p></li>
								<li><p class="float-left">주문자 휴대폰번호</p><p class="last-child float-right">EL로받을곳</p></li>
								<li><p class="float-left">주문자 E-mail</p><p class="last-child float-right">EL로받을곳</p></li>
								<li><p class="strong float-left">결제정보</p><p class="last-child float-right"></p></li>
								<li><p class="float-left">결제수단</p><p class="last-child float-right">EL로받을곳</p></li>
								<li><p class="float-left">결제카드</p><p class="last-child float-right">EL로받을곳</p></li>	
								<li><p class="float-left">승인시간</p><p class="last-child float-right">EL로받을곳</p></li>
								<li><p class="float-left">승인번호</p><p class="last-child float-right">EL로받을곳</p></li>
								<li><p class="float-left">할부개월</p><p class="last-child float-right">EL로받을곳</p></li>
								<li><p class="float-left">무이자여부</p><p class="last-child float-right">EL로받을곳</p></li>
								<li><p class="float-left">영수증확인</p><p class="last-child float-right">EL로받을곳</p></li>
								
								<li><p class="strong float-left">order total</p><p class="last-child strong float-right">$190.98</p>
								<button class="button large color-hover float-right">place order</button></li>
							</ul>
						</form>
					</div><!-- 오더 디테일 픽스 -->
				</div><!-- 오더 디테일 래퍼 -->
