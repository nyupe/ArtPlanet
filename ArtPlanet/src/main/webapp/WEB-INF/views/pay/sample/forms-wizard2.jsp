                                                    ...
                                                    <div class="form-wizard-content">
                                                        <div id="step-1">
                                                            ...
                                                            <div class="position-relative form-group"><label
                                                                    ...
                                                                    placeholder="예) 서울특별시 금천구 가산로11" type="text"
                                                                    class="form-control"></div>
                                                            <div class="position-relative form-group"><label
                                                                    for="exampleAddress2">상세주소</label><input
                                                                    name="address2" id="exampleAddress2"
                                                                    placeholder="예) 4층 한국소프트인재개발원" type="text"
                                                                    class="form-control">
                                                            </div>
                                                            <div class="form-row">
                                                                <div class="col-md-6">
                                                                           ...
                                                                           <select class="multiselect-dropdown form-control" name="pay_method">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="position-relative form-group">
                                                                                        ...
                                                                                        <input  class="form-control" placeholder="주문번호" type="text" name="ordr_idxx" value="TEST1234" maxlength="40" />
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <div class="position-relative form-group">
