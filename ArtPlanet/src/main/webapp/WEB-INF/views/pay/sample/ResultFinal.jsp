               ...
               <div class="form-wizard-content">
                  ...
                  <div id="step-3">
                     <div class="no-results">
                        ...
                        <div class="results-title">결제가 정상적으로 완료되었습니다!!</div>
...
%>
                    <tr>
                       ...
                       <td class="sub_content1"><a href="javascript:receiptView('<%=tno%>','<%= ordr_idxx %>','<%= amount %>')"><img src="./img/btn_receipt.png" alt="영수증을 확인합니다." />
                    	  ...
                    	  <button class="mb-2 mr-2 btn-pill btn-hover-shine btn btn-warning"  onclick="javascript:receiptView('<%=tno%>','<%= ordr_idxx %>','<%= amount %>');"> 영수증 확인 </button>
