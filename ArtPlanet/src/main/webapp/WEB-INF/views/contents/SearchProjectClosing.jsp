...
<section class="portfolio_area area-padding" id="portfolio">
	...
	<div class="container">
		...
		<div class="filters portfolio-filter" style="display: inline; margin-bottom: 20px;">
			...
			<ul>
				...
				<div style="float:right;">
					...
					<form action="<c:url value='/Search/Project/ProjectWrite'/>">
						...
						<button class="btn-wide mb-2 mr-2 btn-icon btn-icon-right btn-pill btn btn-warning btn-lg" type="submit" name="${id }">

						글쓰기<i class="pe-7s-science btn-icon-wrapper"> </i></button>
