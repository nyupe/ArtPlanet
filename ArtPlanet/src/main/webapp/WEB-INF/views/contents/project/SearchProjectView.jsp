			...
			<div class="col-lg-8 mb-5 mb-lg-0">
				...
				<div class="blog_left_sidebar">
					...
					<div class="blog_details">
							...
							<h2 style="float: left;">업데이트 소식</h2>&nbsp;<span class="badge badge-primary" style="margin-bottom: 15px; vertical-align: center">4</span>

							<form class="update" style="clear: both;" method="post" action="<c:url value='/Search/Project/projectInsertUpdate'/>">
								...
								<div >
									...
									style="border-radius:2px;border: #da624a 1px solid ;cursor: pointer;background: #da624a;color: white;font-size: 1.4em">등록하기</button>
