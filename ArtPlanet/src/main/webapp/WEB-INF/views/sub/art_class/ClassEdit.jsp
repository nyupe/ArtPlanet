		...
		<div class="col-md-12" style="padding: 200px;">
			...
			<!--================Blog Area =================-->
			    ...
			    <h5 class="card-title" style="margin: 20px;">카테고리 선택해주세요</h5> 
                          	...
                          	<select class="form-control" id="" name="chcategory" style=" margin: 20px; position: relative;left: 200%;">
			...
			<form action="<c:url value='/View_Input'/>" method="post" onsubmit="addScheduleInput()" >   
									...
									<div class="col-lg-12 posts-list">
										<div class="write-form">
											...
											<div class="form-group" style="margin-top:10px;">
												<input type="text" name="title" class="form-control" id="text-title" placeholder="글제목(필수)">
											</div>
				...
				<div class="card-body">
					<div class="form-group row" style="position: relative; left: 20px;">
						...
						<div class="col-sm-6">
							<div class="form-check">
								<input name="classLevel" type="radio" name="toasts" class="form-check-input"
									value="상" checked /> <label class="form-check-label"
									for="exampleRadios1"> 상 </label>
							</div>
							<div class="form-check">
								<input name="classLevel" type="radio" name="toasts" class="form-check-input"
									value="중" checked /> <label class="form-check-label"
									for="exampleRadios1"> 중 </label>
							</div>
							<div class="form-check">
								<input name="classLevel" type="radio" name="toasts" class="form-check-input"
									value="하" checked /> <label class="form-check-label"
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<div class="input-group">
									...
									<input name="timeRequired" class="form-control input-mask-trigger" 
										im-insert="true" style="text-align: right;" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)' style='ime-mode:disabled;' /><span style="padding: 8px;">시간</span>
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<div class="input-group">
									...
									<input name="numberOfPeople" class="form-control input-mask-trigger" 
										im-insert="true" style="text-align: right;"  onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)' style='ime-mode:disabled;' ><span style="padding: 8px;">명</span>
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<div class="input-group">
									...
									<input name="tuitionFee" class="form-control input-mask-trigger"
					...
					<div class="main-card mb-3 card">
						<div class="card-body">
							...
							<div id="scheduleList" class="col-sm-6" style=" margin: 25px; left: 25%;"></div>
							<script>
							...
							<!-- 시간 입력 -->
							<input id="total" name="total" type="hidden" style="display: none;" value=""/>						
							<div class="form-group row">
								<label for="inputPassword"
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<div class="input-group">
										...
										<select class="form-control" id="timepicker" name="openingTime">
		...
		<!-- 주소 입력 -->
				 <div class="main-card mb-6 card">
                        ...
                        <h5 class="card-title">클래스 주소</h5>
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <button class="btn btn-secondary" disabled>클래스 주소
                                        </button>
                                    </div>
                                    <input name="classAddress" id="classAddr" type="text" class="form-control" readonly >
                                </div>
                                <br>
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        ...
                                        <input id="detailAddr" name="detailedAddr" type="text" class="form-control">
                                    </div> 
                                </div>
                            </div>
						</div>
