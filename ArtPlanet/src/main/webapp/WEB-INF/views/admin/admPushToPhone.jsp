...
<%!
	...
	//->클라우드 메시징->서버키 복사
	//final String apiKey = "AAAAXSmRm_U:APA91bHVIYe6ubHcdfatoU1h0s8CbUCM3SFJ9715bwZDRaihYjkZo4-otrKgyxxSxMzAyv5gjvmf68CcCtktLcQWwe-nRSKsIt3LgtY0rV7w1i3gWvUiPMS0QYgLoP68wtsb2f8Gq-hw";
	final String apiKey = "AAAABs1ngUg:APA91bGguCG638Z31tsWtlYLJ3TnrO812A8K7dP310i7S0CWxAdO0cuPiQ3EOxzUkhC3EeIghtoTX_FV6k8QP3mpQC2IRlvHJ1ctqBTEfFaGXXgqTZ3FX-AUfJgsBhwCi_DZalZW1rQc"; //준식
			//"AAAAQpt81KA:APA91bE-u_loy5IxCSgRqFpwyHgWmOmYZd82skf_LTM_hQmslyQMha-LYZh_iHjytfCYWIALD_2hxBrrYA99X_QyTaO-xEMiGUk8mOdPq85M3nIClXzoJ_CLOFG4jRLmydM35vo4oSbg";
//	                       AAAAQpt81KA:APA91bE-u_loy5IxCSgRqFpwyHgWmOmYZd82skf_LTM_hQmslyQMha-LYZh_iHjytfCYWIALD_2hxBrrYA99X_QyTaO-xEMiGUk8mOdPq85M3nIClXzoJ_CLOFG4jRLmydM35vo4oSbg
//                         AAAAs0kHueQ:APA91bHGTRkyCjodfT5wj8mOJNeboGpf7Rz9UeeY_UOTwasDBnlI6sMNPxZarPhJT7EiBe5-vOapi_S2ml6eiVkTRbz0rE4agar-RGxXf8B9oopl_6zI3cr8uX-tcIfhIOi0r8-1TRqA	
...
<%
    ...
    String message = request.getParameter("noti_message");
    String title = request.getParameter("noti_title");;
    int successTokens=0;
    try {
    	Class.forName("oracle.jdbc.OracleDriver");
       
        conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:orcl","ARTPLANET","ARTPLANET");
...
<%
	...
	tokens.clear();
	resultArray.clear();
    System.out.println("successTokens:"+successTokens);
%>
